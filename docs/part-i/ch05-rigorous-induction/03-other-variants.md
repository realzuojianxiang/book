...
First, observe the following cases: $20 > 02 \Leftrightarrow 1 > 0 so P(0) is True 21 > 12 \Leftrightarrow 2 > 1 so P(1) is True 22 > 22 \Leftrightarrow 4 > 4 so P(2) is False 23 > 32 \Leftrightarrow 8 > 9 so P(3) is False 24 > 42 \Leftrightarrow$16 > 16 so P(4) is False Notice that whenever z \leq−1, we have 2z < 1 and z2 \geq1, so 2z ̸> z2. Thus, P(n) is False for every n that satisfies n \leq−1. Next, define S to be the set S = {z $\in \mathbb{N}$ | z \geq5}. We will prove \forall n \in S. P(n) holds by induction on n. BC: Observe that P(5) holds because 25 = 32 and 52 = 25 and 32 > 25. IH: Let k $\in \mathbb{N}$ be arbitrary and fixed. Suppose that P(k) holds. IS: Since k \in S, we know k $\geq$5 and so k > 4. Thus, k −1 > 3 and so (k −1)2 > 9; certainly, then, (k −1)2 > 2.
