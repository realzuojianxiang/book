...
Example 7.4.2. Consider p : $N \times \mathbb{N} \to \mathbb{N}$ defined by p(a, b) = ab. Is p surjective?
...
Example 7.4.4. Let d : $N \times \mathbb{N} \to \mathbb{Z}$ be the function defined by
...
Example 7.4.7. Consider p : $N \times \mathbb{N} \to \mathbb{N}$ defined by p(a, b) = ab. Is p injective?
...
Example 7.4.9. Let d : $N \times \mathbb{N} \to \mathbb{Z}$ be the function defined by d(a, b) = a −b.
...
$\forall x \in \mathbb{R}$. f(x) = ⌊x⌋ (Recall that ⌊x⌋is the floor of x: it is the largest integer z $\in \mathbb{Z}$ that satisfies z \leq x. Let g : Z $\to \mathbb{N}$ be the function defined by \forall z $\in \mathbb{Z}$. g(z) = ( −z if z < 0 z + 1 if z \geq0 Let's find g ◦f. Notice that whenever x $\in \mathbb{R}$ satisfies x < 0, we will have ⌊x⌋x < 0, as well. Similarly, whenever x $\in \mathbb{R}$ satisfies x \geq0, we will have ⌊x⌋\geq0. This tells us that the composition g ◦f will also be a piece-wise function: \forall x $\in \mathbb{R}$. (g ◦f)(x) = ( −⌊x⌋ if x < 0 ⌊x⌋+ 1 if x $\geq$0
...
Define A = {1, 2} and B = {♥, ♦} and C = {$\star$}. Define f by setting f(1) = ♥and f(2) = ♦. Notice f is injective because f(1) \neq f(2). Define g by setting g(1) = g(2) = \star. Notice g ◦f is defined by (g ◦f)(1) = \starand (g ◦f)(2) = $\star$. This shows g ◦f is not injective, because (g ◦f)(1) = (g ◦f)(2) but 1 \neq 2.
