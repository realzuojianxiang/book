...
|Si| < n k for every i. Since the sets form a partition of S, we have n = |S| = k X i=1 |Si| < k X i=1 n k = n so n < n. This is a contradiction! ×××× AFSOC all of the numbers xi satisfy xi < z n. Then, z = n X i=1 xi < n X i=1 z n = n $\cdot$ z n = z so z < z. This is a contradiction. ×××× Notice how similar these proofs are! They look identical, algebraically. Indeed, they represent the same underlying idea.
### 8.6.3 Examples
